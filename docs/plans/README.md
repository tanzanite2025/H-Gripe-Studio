...
| [`active/STUDIO_PROJECT_MULTI_CANVAS_WORKSPACE_PLAN.md`](active/STUDIO_PROJECT_MULTI_CANVAS_WORKSPACE_PLAN.md) | Defines project containers, multi-canvas tabs, and toolbar command hierarchy. | Use before changing New/Open/Save behavior, canvas tabs, global controls, or toolbar grouping. |
