...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::viewport::viewport_set_image_scene,
            commands::viewport::viewport_resize,
            commands::viewport::viewport_set_grade,
            commands::viewport::viewport_set_clip_props,
            ...
            commands::viewport::viewport_present_image_layer_scene,
            commands::viewport::viewport_render_frame,
            commands::viewport::viewport_render_frame_bin,
            commands::viewport::viewport_export_frame,
            ...
            commands::viewport::viewport_unregister_layered_asset,
            commands::viewport::viewport_unregister_timeline,
            commands::viewport::viewport_unregister_node_output,
