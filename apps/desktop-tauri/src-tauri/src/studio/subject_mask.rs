...
mod raster_ops;
use raster_ops::{
    apply_mask_path, crop_mask, fill_gradient, fill_holes, fill_marquee, invert, parse_mask_path,
    red_eye_select, stamp_stroke, stamp_stroke_soft, transform_mask, wand_select, MaskPath,
    PathMode,
};
