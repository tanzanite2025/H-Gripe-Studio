// Pure canvas painters for the image-editor stage overlay. Every function takes
// a 2D context plus plain data and draws one scene element — no React state,
// no refs. ImageEditorModal assembles the scene; painting lives here.

import { type EditPath, type EditPathPoint } from "../../contracts/imageEditOps";
import type { ProxyMask } from "../maskMorphology";
import { shapeVertices, type ShapeKind } from "../imageEditorTools";
