...
import { ANCHOR_PATH_TOOLS, toolTargets, type ImageEditorTool, type PaintTarget, type ShapeKind } from "../imageEditorTools";
...
export function ToolOptionsPanel({
  ...
  const usesTolerance =
    (tool.kind === "click" && tool.id !== "red_eye") || tool.id === "quick_select" || tool.id === "background_eraser";
  return (
