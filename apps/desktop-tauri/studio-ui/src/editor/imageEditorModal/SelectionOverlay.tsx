...
export function SelectionOverlay({ dims, frame, draft = null, active = null, phase = 0 }: SelectionOverlayProps) {
  const viewFrame = frame ?? { x: 0, y: 0, w: dims.w, h: dims.h };
  if (dims.w <= 0 || dims.h <= 0 || viewFrame.w <= 0 || viewFrame.h <= 0) return null;
