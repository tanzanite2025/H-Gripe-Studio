// Photoshop-aligned shortcut bindings for the Image Editor scope
...
// scope table for `scope: "image-editor"`.

import type { ShortcutBinding } from "../core";

export const IMAGE_EDITOR_SCOPE = "image-editor";

export const IMAGE_EDITOR_SHORTCUTS: readonly ShortcutBinding[] = [
 ...
 * badges). Keys are `imageEditorTools` ids; values must stay consistent with the
