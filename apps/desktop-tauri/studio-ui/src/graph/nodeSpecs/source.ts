...
export const SOURCE_NODE_SPECS = {
  promptOptimize: {
    ...
    title: "Prompt",
    description:
      "A text prompt fed into generation nodes. Optionally optimize it with deterministic built-in presets or an API profile. Leave optimization off to pass the text through unchanged.",
    category: "source",
    ...
    params: [
      ...
      },
      {
        ...
        label: "Optimize",
        control: "select",
        options: ["off", "builtin", "api"],
        defaultValue: "off",
        hint: "off = pass through · builtin = deterministic rules · api = LLM via profile",
        advanced: true,
      },
      {
        key: "preset",
        ...
        hint: "used by `builtin` mode: dedupe + append booster tags",
        visibleWhen: { param: "mode", in: ["builtin"] },
      },
      {
        key: "api_profile_ref",
        label: "API profile",
