...
export const PSD_NODE_SPECS = {
  ...
  imageEnhance: {
    ...
    title: "Image Enhance",
    description:
      "Upscale a low-resolution subject to a requested pixel size with the deterministic built-in Lanczos, denoise and sharpening path. Connect placeholder bounds to auto-size, or set explicit target pixels. Emits the enhanced image, the applied scale factor, and an enhance report. Presets hide the detail; pick 'custom' to expose denoise, texture and scale.",
    category: "process",
    inputs: [
      port("image", "image", "image"),
    ...
    params: [
      {
        ...
        inline: true,
        hint: "conservative = gentle, texture_rebuild = strong detail, custom = expose sliders",
      },
      {
        key: "target_width",
        label: "Target width",
