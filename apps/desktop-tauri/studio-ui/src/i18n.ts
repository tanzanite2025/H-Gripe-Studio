...
export const messages = {
  ...
  "imageSourceEditor.blockedTitle": {
    en: "This draft cannot be edited safely",
    zh: "此草稿无法安全编辑",
  },
  "imageSourceEditor.blockedReason": {
    en: "Reason: {reason}",
    zh: "原因：{reason}",
  },
  "imageSourceEditor.blockedUnchanged": {
    en: "The original draft remains unchanged.",
    zh: "原始草稿保持不变。",
  },
  ...
  "palette.executorBuiltin": { en: "Built-in", zh: "内置" },
  "palette.executorApi": { en: "API", zh: "API" },
  "palette.executorBuiltinApi": { en: "Built-in / API", zh: "内置 / API" },
  ...
  "mask.pathEditToolHint": {
    en: "Click a committed path outline to select it, then drag to move it; use anchor edit mode for individual points. Done commits.",
    zh: "点击已提交路径的轮廓选中它，然后拖动整条路径；单个锚点调整走锚点编辑模式，点「完成」提交。",
  },
  ...
  "mask.samPoints": { en: "Selection points ({count})", zh: "选择点（{count}）" },
  "mask.pointsEmpty": {
    en: "none - pick Point selection and click the subject",
    zh: "无 - 选择点选工具并点击主体",
  },
  "mask.notePrefix": { en: "Edits ({count}) are recorded as ", zh: "编辑（{count}）记录为 " },
  "mask.noteSuffix": {
    en: " and applied by the built-in processor on run. Point prompts use left-click to include and right-click to exclude; Matting paints the trimap unknown band for deterministic soft-alpha refinement; Pen/Lasso paths are rasterised and boolean-combined (add/subtract/intersect).",
    zh: "，在运行时由内置处理器应用。点提示使用左键包含、右键排除；抠像在三分图未知带上涂抹并进行确定性软 alpha 精修；钢笔/套索路径会被栅格化并布尔合并（添加/减去/交集）。",
  },
  ...
  "drawer.propsKeyframeToggle": {
    en: "add / remove keyframe at the playhead; right-click a key to set interpolation",
    zh: "在播放头处添加/删除关键帧；右键关键帧可设置插值",
  },
  "drawer.propsInterpLinear": { en: "Linear", zh: "线性" },
  "drawer.propsInterpHold": { en: "Hold", zh: "保持" },
  "drawer.propsInterpBezier": { en: "Bezier (ease in/out)", zh: "贝塞尔（缓入缓出）" },
  "drawer.propsPosition": { en: "Position", zh: "位置" },
  "drawer.propsAnchor": { en: "Anchor", zh: "锚点" },
  "drawer.propsScale": { en: "Scale", zh: "比例" },
  "drawer.propsRotation": { en: "Rotation", zh: "旋转" },
  "drawer.propsOpacity": { en: "Opacity", zh: "不透明度" },
  "drawer.propsX": { en: "X", zh: "X" },
  "drawer.propsY": { en: "Y", zh: "Y" },
  "drawer.propsCropLeft": { en: "Left", zh: "左" },
  ...
  "exportFrame.openTitle": { en: "Export the current monitor frame", zh: "导出当前监视器帧" },
  "exportFrame.title": { en: "Export Frame", zh: "导出帧" },
  "exportFrame.name": { en: "Name", zh: "名称" },
  "exportFrame.format": { en: "Format", zh: "格式" },
  "exportFrame.path": { en: "Path", zh: "路径" },
  "exportFrame.browse": { en: "Browse…", zh: "浏览…" },
  "exportFrame.pickPathTitle": { en: "Choose frame export folder", zh: "选择导出帧文件夹" },
  "exportFrame.addToProject": { en: "Add to Project", zh: "导出到项目中" },
  "exportFrame.confirm": { en: "OK", zh: "确定" },
  "exportFrame.confirmTitle": { en: "Export this frame", zh: "导出此帧" },
  "exportFrame.running": { en: "exporting…", zh: "导出中…" },
  "exportFrame.noFrame": { en: "No monitor frame is ready to export.", zh: "当前没有可导出的监视器帧。" },
  "exportFrame.addedToProject": { en: "Exported frame added to the media workspace.", zh: "已将导出帧加入素材工作区。" },
  "drawer.trackVideo": { en: "V", zh: "视" },
  "drawer.trackAudio": { en: "A", zh: "音" },
  "drawer.trackImage": { en: "I", zh: "图" },
  "drawer.timelineToolSelect": { en: "Selection tool", zh: "选择工具" },
  "drawer.timelineToolRazor": { en: "Razor tool", zh: "剃刀 / 切割工具" },
  "drawer.timelineToolHand": { en: "Hand tool (drag to pan the zoomed timeline)", zh: "抓手工具（按住拖动平移缩放后的时间线）" },
  ...
  "drawer.addImageTrackTitle": { en: "add an image track", zh: "新增一条图片轨" },
  ...
  "drawer.removeTrackTitle": {
    en: "remove this track and its clips (the last track of each kind stays)",
  ...
  "assistant.backendBuiltin": {
    en: "Built-in deterministic rewriter",
    zh: "内置确定性改写",
  },
  "assistant.backendGone": {
    en: "API profile \"{ref}\" is no longer in API Profiles - pick another backend.",
    zh: "API 配置“{ref}”已不在 API 配置管理器中，请换一个后端。",
  },
  "assistant.apiError": {
  ...
  "assistant.backendUnavailable": {
    en: "{ref} (API profile unavailable)",
    zh: "{ref}（API 配置不可用）",
  },
  "assistant.preset": { en: "Preset", zh: "预设" },
  "assistant.empty": {
    en: "Describe an idea and the assistant rewrites it into a prompt draft.",
    zh: "输入想法，助手会把它改写成提示词草稿。",
  },
  ...
  "btn.models": { en: "API Profiles", zh: "API 配置" },
  "btn.modelsTitle": {
    en: "open the API profile manager",
    zh: "打开 API 配置管理器",
  },
  "models.title": { en: "API Profiles", zh: "API 配置" },
  ...
  "models.selector.hint": {
    en: "capability-filtered from API Profiles; fills provider / model / credentials",
    zh: "来自 API 配置管理器的能力过滤列表；自动填充 provider / model / credentials",
  },
  ...
  "models.selector.builtin": { en: "Built-in deterministic presets", zh: "内置确定性预设" },
  ...
  "models.apiViewConfigured": { en: "Configured", zh: "已对接" },
  "models.apiViewTemplates": { en: "Templates", zh: "模板" },
  "models.presetsTitle": { en: "Quick add from a provider preset:", zh: "从服务商预设快速添加：" },
  "models.presetsHint": {
    en: "everything is prefilled and editable (base URL too, for relay endpoints) — just fill in your API key reference and save",
